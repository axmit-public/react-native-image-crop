...
export interface ImageCropRef {
  /** Gets and returns current crop offset, width and height as well as a
   * `zoomData` object that you can use to restore cropper state after unmounting
   * and re-visitng the cropper to adjust your crop */
  getCropData: () => ImageCropResponse;
}
...
const ImageCrop = forwardRef<ImageCropRef, IImageCropProps>(
  (props: IImageCropProps, ref) => {
    ...
    const zoomDistance = useRef<number>(1);
    ...
    const getEdgeCropHandlePanResponder = (
      position: CropHandleEdgePosition
    ) => {
    ...
    useImperativeHandle<ImageCropRef, ImageCropRef>(
      ref,
      () => {
            ...
            >
              ...
              <View style={[styles.bottomLeftCornerHandle]}>
                <View
                  ...
                  {...getCornerCropHandlePanResponder("bottom-left")
                    .panHandlers}
                />
              </View>
              <View style={[styles.bottomRightCornerHandle]}>
                <View
                  ...
                  {...getCornerCropHandlePanResponder("bottom-right")
                    .panHandlers}
                />
              </View>
            </Animated.View>
